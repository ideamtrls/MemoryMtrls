...
- Present **a few options to choose from**. Recommended one of the options and
  offer 2-3 alternative groupings (finer-grained vs. coarser, or organized by
...
- For each approved category, create `memory/<name>.md` exactly per SPEC.md:
